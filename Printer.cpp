...
IceProxy::Demo::Printer::printString(const ::std::string& s, const ::Ice::Context* __ctx)
{
    ...
    while(true)
    {
        ...
        try
        {
            __checkTwowayOnly(__Demo__Printer__printString_name);
            __delBase = __getDelegate(false);
            ::IceDelegate::Demo::Printer* __del = dynamic_cast< ::IceDelegate::Demo::Printer*>(__delBase.get());
            return __del->printString(s, __ctx, __observer);
        }
...
{
    __checkAsyncTwowayOnly(__Demo__Printer__printString_name);
...
{
    ::Ice::AsyncResult::__check(__result, this, __Demo__Printer__printString_name);
    ::std::string __ret;
...
IceDelegateD::Demo::Printer::printString(const ::std::string& s, const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    ...
    public:
        ...
        run(::Ice::Object* object)
        {
            ...
            _result = servant->printString(_m_s, _current);
...
Demo::Printer::___printString(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    __is->read(s);
    __inS.endReadParams();
    ::std::string __ret = printString(s, __current);
