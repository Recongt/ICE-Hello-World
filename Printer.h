...
public:
    ...
    ::std::string printString(const ::std::string& s)
    {
        return printString(s, 0);
    }
    ::std::string printString(const ::std::string& s, const ::Ice::Context& __ctx)
    {
        return printString(s, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_printString(const ::std::string& s, const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_printString(s, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    ...
    ::Ice::AsyncResultPtr
    begin_printString(const ::std::string& s, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_printString(s, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
...
private:
    ...
    ::Ice::AsyncResultPtr __begin_printString(const ::std::string& s, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        ...
        return begin_printString(s, __ctx, new Cpp11CB(__response, __exception, __sent));
    }
...
public:
    ...
    ::std::string end_printString(const ::Ice::AsyncResultPtr&);
    
private:

    ::std::string printString(const ::std::string&, const ::Ice::Context*);
...
public:
    ...
    virtual ::std::string printString(const ::std::string&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
public:
    ...
    virtual ::std::string printString(const ::std::string&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
...
public:
    ...
    virtual ::std::string printString(const ::std::string&, const ::Ice::Current& = ::Ice::Current()) = 0;
...
template<class T>
class CallbackNC_Printer_printString : public Callback_Printer_printString_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
...
newCallback_Printer_printString(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Printer_printString<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_Printer_printStringPtr
newCallback_Printer_printString(T* instance, void (T::*cb)(const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Printer_printString<T>(instance, cb, excb, sentcb);
}

template<class T, typename CT>
class Callback_Printer_printString : public Callback_Printer_printString_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
...
newCallback_Printer_printString(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Printer_printString<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_Printer_printStringPtr
newCallback_Printer_printString(T* instance, void (T::*cb)(const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Printer_printString<T, CT>(instance, cb, excb, sentcb);
}
